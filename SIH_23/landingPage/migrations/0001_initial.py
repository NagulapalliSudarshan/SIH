# Generated by Django 4.2.1 on 2023-09-20 17:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Istudent_instituteId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='landingPage.institute')),
            ],
        ),
        migrations.CreateModel(
            name='Projects',
            fields=[
                ...
                ('project_studentId', models.ManyToManyField(to='landingPage.projectinstitutestudent')),
            ],
        ),
    ]
